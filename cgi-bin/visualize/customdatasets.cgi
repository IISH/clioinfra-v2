...
#$fromdate= "2012";
$actionurl = "http://beta.clio-infra.eu:8081/cgi-bin/visualize/customdatasets.cgi?showyears=yes&showblock=combinedyears";
if ($showyears)
{
    $actionurl = "http://beta.clio-infra.eu:8081/cgi-bin/visualize/customdatasets.cgi?showyears=yes&showblock=combinedyears";
...
if ($showcountries)
{
    ...
    foreach $mainregion (sort keys %mainregions)
    {
  	...
  	$regionsblock.="&nbsp;<input style=\"width:25px\" value=\"$OPEN\" type=\"button\" onclick='JavaScript:xmlhttpPost(\"$root/cgi-bin/visualize/customdatasets.cgi?showregion=$mainregion&stopblocks=yes&showsubregions=yes&showcountries=yes&action=$ACTION&showblock=combinedcountries\", \"refreshcountries\")'>";
